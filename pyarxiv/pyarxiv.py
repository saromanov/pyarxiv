...
class PyArxiv:
    ...
    def query(self, msg, start=0, max_items=10, sync=True):
        path = 'http://export.arxiv.org/api/query?search_query=all:{0}&start={1}&max_results={2}'.format(msg, start, max_items)
        if sync is False:
